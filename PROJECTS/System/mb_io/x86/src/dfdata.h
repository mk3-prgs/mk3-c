...
//DECLARE_DATA mb_sys mb;
//DECLARE_DATA FATFS FatFs[1];
...
DECLARE_DATA int tzakl;	// время инкубации
...
//
DECLARE_DATA int Ttek;
DECLARE_DATA int Vtek;
DECLARE_DATA int Tist;
DECLARE_DATA int Vist;
DECLARE_DATA int Nobv;
...
//
///DECLARE_DATA uint8_t min;
//==================
DECLARE_DATA uint8_t enable_Cool;
//=======================
...
DECLARE_DATA uint32_t centr_st;
//
...
DECLARE_DATA uint8_t set_rtc[8];
